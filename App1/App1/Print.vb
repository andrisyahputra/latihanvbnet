...
Public Class Printer
    ...
    Shared Sub New()
        _myfont = New Font("Courier New", 8, FontStyle.Regular,
                            GraphicsUnit.Point)
        prn = New Printing.PrintDocument
        AddHandler prn.PrintPage, AddressOf PrintPageHander
    End Sub
    ...
    Private Shared Sub PrintPageHander(ByVal sender As Object, ByVal e As Printing.PrintPageEventArgs)
